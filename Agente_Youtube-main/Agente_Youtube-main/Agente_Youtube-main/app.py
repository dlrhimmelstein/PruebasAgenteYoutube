...
[data-testid="stChatInput"]:focus-within {
    ...
    box-shadow: 0 2px 12px rgba(255,0,0,0.1) !important;
}
...
.yt-sb-divider    { height: 1px; background: #f0f0f0; margin: 6px 0; }
.yt-sb-stats {
    margin: 8px 12px 12px; background: #f9f9f9;
    border-radius: 10px; padding: 12px 14px; border: 1px solid #efefef;
}
.yt-sb-stats-title {
...
.yt-sb-stat-label { color: #777; }
.yt-sb-stat-val   { font-weight: 600; color: #111; }
.yt-sb-status-row { display: flex; justify-content: space-between; align-items: center; padding: 4px 0; }
.yt-sb-dot { display: inline-block; width: 7px; height: 7px; border-radius: 50%; background: #22c55e; margin-right: 5px; }
.yt-sb-status-label { font-size: 12px; color: #777; }
.yt-sb-status-val   { font-size: 12px; font-weight: 600; color: #22c55e; }
...
.yt-header-logo {
    width: 36px; height: 36px; background: #ff0000;
    border-radius: 8px; display: flex; align-items: center; justify-content: center;
}
.yt-header-logo svg { width: 20px; height: 20px; fill: white; }
.yt-header-title { font-size: 18px; font-weight: 700; color: #0f0f0f; line-height: 1.2; }
.yt-header-sub   { font-size: 12px; color: #888; margin-top: 2px; }
.yt-header-badge {
    margin-left: auto; display: flex; align-items: center; gap: 6px;
    font-size: 12px; color: #555; background: #f2f2f2;
    padding: 5px 12px; border-radius: 20px;
}
.yt-header-badge .dot { width: 7px; height: 7px; border-radius: 50%; background: #22c55e; display: inline-block; }

/* ── FILTROS ── */
.yt-filters-row {
    display: flex; align-items: center; flex-wrap: wrap;
    gap: 8px; padding: 10px 0 16px 0;
    border-bottom: 1px solid #efefef; margin-bottom: 16px;
}
.yt-filters-label { font-size: 13px; color: #888; font-weight: 500; margin-right: 4px; white-space: nowrap; }

/* ── BIENVENIDA ── */
.yt-welcome {
    display: flex; flex-direction: column; align-items: center;
    justify-content: center; text-align: center; padding: 60px 20px 40px;
}
.yt-welcome-icon {
    width: 64px; height: 64px; background: #ff0000; border-radius: 16px;
    display: flex; align-items: center; justify-content: center;
    margin-bottom: 20px; box-shadow: 0 4px 14px rgba(255,0,0,0.25);
}
.yt-welcome-icon svg { width: 34px; height: 34px; fill: white; }
.yt-welcome-title { font-size: 22px; font-weight: 700; color: #0f0f0f; margin-bottom: 12px; }
.yt-welcome-desc  { font-size: 14px; color: #606060; max-width: 420px; line-height: 1.7; }
.yt-welcome-desc b { color: #0f0f0f; font-weight: 600; }

/* ── INPUT FOOTER ── */
.yt-input-footer { text-align: center; font-size: 11px; color: #aaa; margin-top: 6px; }
...
with st.sidebar:
    ...
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-orange"><i class="ti ti-trophy"></i></div>
        <div><div class="yt-sb-item-title">Top videos</div><div class="yt-sb-item-sub">Ranking por vistas</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-blue"><i class="ti ti-calendar-stats"></i></div>
        <div><div class="yt-sb-item-title">Mejor día para publicar</div><div class="yt-sb-item-sub">Análisis de rendimiento</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-green"><i class="ti ti-flame"></i></div>
        <div><div class="yt-sb-item-title">Temas más exitosos</div><div class="yt-sb-item-sub">Por engagement</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-purple"><i class="ti ti-chart-bar"></i></div>
        <div><div class="yt-sb-item-title">Resumen del canal</div><div class="yt-sb-item-sub">Stats generales</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-teal"><i class="ti ti-layout-grid"></i></div>
        <div><div class="yt-sb-item-title">Formatos que funcionan</div><div class="yt-sb-item-sub">Shorts vs podcasts</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-pink"><i class="ti ti-heart"></i></div>
        <div><div class="yt-sb-item-title">Mayor engagement</div><div class="yt-sb-item-sub">Likes y comentarios</div></div>
    </div>
    ...
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-blue"><i class="ti ti-search"></i></div>
        <div><div class="yt-sb-item-title">Buscar por tema</div><div class="yt-sb-item-sub">¿En qué ep hablaron de X?</div></div>
    </div>
    <div class="yt-sb-item">
        <div class="yt-sb-icon ic-yellow"><i class="ti ti-video"></i></div>
        <div><div class="yt-sb-item-title">Analizar video</div><div class="yt-sb-item-sub">Por título o URL</div></div>
    </div>
    ...
    <div class="yt-sb-stats">
        <div class="yt-sb-stats-title">Canal al día</div>
        <div class="yt-sb-stat-row"><span class="yt-sb-stat-label">Videos</span><span class="yt-sb-stat-val">299</span></div>
        <div class="yt-sb-stat-row"><span class="yt-sb-stat-label">Views totales</span><span class="yt-sb-stat-val">16.7M</span></div>
        <div class="yt-sb-stat-row"><span class="yt-sb-stat-label">Likes totales</span><span class="yt-sb-stat-val">716K</span></div>
        <div class="yt-sb-stat-row"><span class="yt-sb-stat-label">Comentarios</span><span class="yt-sb-stat-val">34.8K</span></div>
        <div class="yt-sb-divider" style="margin:6px 0;"></div>
        <div class="yt-sb-status-row">
            <span class="yt-sb-status-label"><span class="yt-sb-dot"></span>Estado del agente</span>
            <span class="yt-sb-status-val">Activo</span>
        </div>
    </div>
    """, unsafe_allow_html=True)

    # Botones invisibles — disparan prompts sugeridos
    if st.button("Top videos", key="btn_top"):
        st.session_state.prompt_sugerido = "¿Cuáles son mis 5 videos con más vistas?"
    if st.button("Mejor día para publicar", key="btn_dia"):
        st.session_state.prompt_sugerido = "¿Qué días de la semana son mejores para publicar?"
...
# 7. FILTROS
# =========================
st.markdown('<div class="yt-filters-row"><span class="yt-filters-label">Filtrar:</span></div>', unsafe_allow_html=True)
...
contexto_filtros = f"Filtra la respuesta considerando solo: {', '.join(filtro_activo)}." if filtro_activo else ""
...
# =========================
# 9. ÁREA PRINCIPAL — BIENVENIDA O HISTORIAL
# =========================
if not st.session_state.messages:
    st.markdown("""
    <div class="yt-welcome">
